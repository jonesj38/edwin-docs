...
This is ideal for workflow engines like Pipelines: you can add a single LLM step
without writing custom Edwin code for each workflow.
...
## Example: Pipelines workflow step
