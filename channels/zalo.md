...
- Install via CLI: `edwin plugins install @edwin/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `edwin plugins install ./extensions/zalo`
   - From npm (if published): `edwin plugins install @edwin/zalo`
...
- Approve via:
  - `edwin pairing list zalo`
  - `edwin pairing approve zalo <CODE>`
...
- Example: `edwin message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `edwin channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `edwin logs --follow`
