...
Edwin has two separate “streaming” layers:
...
When block streaming is enabled, Edwin can **merge consecutive block chunks**
...
When draft streaming is active, Edwin disables block streaming for that reply to avoid double-streaming.
