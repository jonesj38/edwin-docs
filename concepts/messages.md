...
This page ties together how Edwin handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Edwin keeps a
...
Edwin separates the **prompt body** from the **command body**:
...
Edwin can expose or hide model reasoning:
