...
Deploy Edwin on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/edwin` — Control UI
...
- `EDWIN_STATE_DIR=/data/.edwin` (recommended)
- `EDWIN_WORKSPACE_DIR=/data/workspace` (recommended)
- `EDWIN_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Edwin state + workspace so you can migrate to another host without losing config or memory.
