...
Edwin treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.edwin/settings/voicewake.json`

Shape:

```json
{ "triggers": ["edwin", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
...
- All WebSocket clients (Edwin Desktop, WebChat, etc.)
