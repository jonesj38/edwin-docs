...
Target: Clawd-style workspace (`agents.defaults.workspace`, default `~/.edwin/workspace`) where “memory” is stored as one Markdown file per day (`memory/YYYY-MM-DD.md`) plus a small set of stable files (e.g. `memory.md`, `SOUL.md`).
