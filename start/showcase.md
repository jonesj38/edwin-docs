...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @edwin on X](https://x.com/edwin).
</Info>
...
Edwin connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @edwin](https://x.com/edwin)
  </Step>
