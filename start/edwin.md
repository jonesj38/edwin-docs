---
summary: "End-to-end guide for running Edwin as a personal assistant with safety cautions"
read_when:
...
3. Put a minimal config in `~/.edwin/edwin.json`:
...
By default, Edwin runs a heartbeat every 30 minutes with the prompt:
