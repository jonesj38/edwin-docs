---
summary: "Frequently asked questions about Edwin setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What's the recommended way to install and set up Edwin?](#whats-the-recommended-way-to-install-and-set-up-edwin)
  ...
  - [I can't access docs.edwinpai.com (SSL error). What now?](#i-cant-access-docsedwinai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or edwin not recognized](#windows-install-says-git-not-found-or-edwin-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Edwin on Linux?](#how-do-i-install-edwin-on-linux)
  - [How do I install Edwin on a VPS?](#how-do-i-install-edwin-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Edwin to update itself?](#can-i-ask-edwin-to-update-itself)
  ...
  - [If I buy a Mac mini to run Edwin, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-edwin-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Edwin instances?](#can-multiple-people-use-one-whatsapp-number-with-different-edwin-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Edwin on a dedicated machine?](#how-important-is-it-to-run-edwin-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Edwin in a VM and what are the requirements](#can-i-run-edwin-in-a-vm-and-what-are-the-requirements)
- [What is Edwin?](#what-is-edwin)
  - [What is Edwin, in one paragraph?](#what-is-edwin-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Edwin](#what-are-the-top-five-everyday-use-cases-for-edwin)
  - [Can Edwin help with lead gen outreach ads and blogs for a SaaS](#can-edwin-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Edwin run tasks on a schedule or continuously in the background?](#can-edwin-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Edwin saved locally?](#is-all-data-used-with-edwin-saved-locally)
  - [Where does Edwin store its data?](#where-does-edwin-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Edwin?](#how-do-i-completely-uninstall-edwin)
...
- [Config basics](#config-basics)
  ...
  - [Can the Edwin browser run headless?](#can-the-edwin-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Edwin instances talk to each other (local + VPS)?](#can-two-edwin-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Edwin load environment variables?](#how-does-edwin-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Edwin instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-edwin-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Edwin but keep it installed?](#how-do-i-completely-reset-edwin-but-keep-it-installed)
  ...
  - [Why doesn't Edwin reply in a group?](#why-doesnt-edwin-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Edwin, Flawd, and Krill use for models?](#what-do-edwin-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `edwin gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-edwin-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `edwin gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-edwin-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Edwin in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-edwin-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Edwin?](#i-closed-my-terminal-on-windows-how-do-i-restart-edwin)
  ...
  - [ELI5: `edwin gateway restart` vs `edwin gateway`](#eli5-edwin-gateway-restart-vs-edwin-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Edwin to inbound DMs?](#is-it-safe-to-expose-edwin-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/edwin/edwin-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   edwin health --json
   edwin health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://edwinpai.com/install.sh | bash -s -- --install-method git
```

This installs Edwin **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/jonesj38/edwin/issues
https://github.com/jonesj38/edwin/pulls
...
- `edwin status`: quick snapshot of gateway/agent health + basic config.
- `edwin models status`: checks provider auth + model availability.
- `edwin doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `edwin status --all`, `edwin logs --follow`,
`edwin gateway status`, `edwin health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Edwin
...
If you don't have a global install yet, run it via `pnpm edwin onboard`.
...
- If it asks for auth, run `edwin dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `EDWIN_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `edwin gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `edwin gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `edwin dashboard`.
...
1. Install Edwin on the new machine.
2. Copy `$EDWIN_STATE_DIR` (default: `~/.edwin`) from the old machine.
3. Copy your workspace (default: `~/.edwin/workspace`).
4. Run `edwin doctor` and restart the Gateway service.
...
under `~/.edwin/` (for example `~/.edwin/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-edwin-store-its-data),
...
https://github.com/jonesj38/edwin/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.edwinpai.com SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.edwinpai.com` via Xfinity
Advanced Security. Disable it or allowlist `docs.edwinpai.com`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsedwinai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/jonesj38/edwin/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://edwinpai.com/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://edwinpai.com/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://edwinpai.com/install.ps1
...
```bash
curl -fsSL https://edwinpai.com/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://edwinpai.com/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://edwinpai.com/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or edwin not recognized
...
**2) edwin is not recognized after install**
...
### How do I install Edwin on Linux
...
### How do I install Edwin on a VPS
...
### Can I ask Edwin to update itself
...
edwin update
edwin update status
edwin update --channel stable|beta|dev
edwin update --tag <dist-tag|version>
edwin update --no-restart
```

If you must automate from an agent:

```bash
edwin update --yes --no-restart
edwin gateway restart
```
...
`edwin onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Edwin with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `edwin models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `edwin models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `edwin models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes - via **setup-token**. Edwin no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Edwin can keep replying while a provider is rate-limited.
...
Edwin supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Edwin fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `edwin.json`.

Steps:

1. Enable the plugin: `edwin plugins enable google-gemini-cli-auth`
2. Login: `edwin models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Edwin needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Edwin runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
- DM your bot, then run `edwin logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Edwin instances
...
If you run Edwin via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Edwin code install. Your state
(`~/.edwin`) and workspace (`~/.edwin/workspace`) stay untouched.
...
**Edwin-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Edwin on a dedicated machine
...
Edwin is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Edwin in a VM and what are the requirements
...
### What is Edwin in one paragraph

Edwin is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Edwin is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Edwin
...
### Can Edwin help with lead gen outreach ads and blogs for a SaaS
...
Edwin draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Edwin is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Edwin when you
...
Showcase: https://edwinpai.com/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.edwin/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.edwin/edwin.json`). Precedence is `<workspace>/skills` > `~/.edwin/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.
...
- Confirm cron is enabled (`cron.enabled`) and `EDWIN_SKIP_CRON` is not set.
...
```bash
edwin cron run <jobId> --force
edwin cron runs --id <jobId> --limit 50
```
...
Not directly. macOS skills are gated by `metadata.edwin.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-edwin-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Edwin can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.edwin/skills`) to allow Linux:
   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "edwin": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
- Persist `/home/node` with `EDWIN_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `EDWIN_DOCKER_APT_PACKAGES`.
...
Edwin memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Edwin also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Edwin auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Edwin
prefers `local`.
...
### Is all data used with Edwin saved locally

No - **Edwin's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.edwin` + your workspace directory).
...
### Where does Edwin store its data

Everything lives under `$EDWIN_STATE_DIR` (default: `~/.edwin`):

| Path                                                         | Purpose                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| `$EDWIN_STATE_DIR/edwin.json`                                | Main config (JSON5)                                          |
| `$EDWIN_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$EDWIN_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$EDWIN_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$EDWIN_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$EDWIN_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$EDWIN_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$EDWIN_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.edwin/agent/*` (migrated by `edwin doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.edwin/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.edwin`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.edwin`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.edwin/skills`).

Default workspace is `~/.edwin/workspace`, configurable via:
...
Do **not** commit anything under `~/.edwin` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Edwin
...
`workspace` to the repo root. The Edwin repo is just source code; keep the
...
Edwin reads an optional **JSON5** config from `$EDWIN_CONFIG_PATH` (default: `~/.edwin/edwin.json`):

```
$EDWIN_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.edwin/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `EDWIN_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `edwin doctor --generate-gateway-token`.
...
key. **Recommended:** run `edwin configure --section web` to store it in
...
- Daemons read env vars from `~/.edwin/.env` (or the service environment).
...
### Can the Edwin browser run headless
...
- Gateway is running: `edwin gateway status`
- Gateway health: `edwin status`
- Channel health: `edwin channels status`
...
### Can two Edwin instances talk to each other local VPS
...
`edwin agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
edwin agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.edwin/edwin.json`).
- If you have no backup, re-run `edwin doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `edwin config set` for small changes.
- Use `edwin configure` for interactive edits.
...
### How does Edwin load environment variables

Edwin reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.edwin/.env` (aka `$EDWIN_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.edwin/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`EDWIN_LOAD_SHELL_ENV=1`, `EDWIN_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`edwin models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Edwin won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.edwin/.env`:
   ```
...
### Is there a way to make a team of Edwin instances one CEO and many agents
...
### How do I completely reset Edwin but keep it installed
...
```bash
edwin reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `EDWIN_PROFILE`), reset each state dir (defaults are `~/.edwin-<profile>`).
- Dev reset: `edwin gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Edwin skips the heartbeat run to save API calls.
...
No. Edwin runs on **your own account**, so if you're in the group, Edwin can see it.
...
```bash
edwin directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Edwin reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.edwin/agents/<agentId>/sessions/`.
...
- Use `edwin doctor` to spot stray workspaces and profile mismatches.
...
Edwin's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Edwin currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `edwin models set ...` (updates just model config)
- `edwin configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.edwin/edwin.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `edwin doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Edwin, Flawd, and Krill use for models

- **Edwin + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. Edwin ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.edwin/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `edwin agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Edwin can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.edwin/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.edwin/agent/*` (migrated by `edwin doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.edwin/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `edwin models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `edwin models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `edwin models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.edwin/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    edwin models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Edwin will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Edwin now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Edwin uses provider-prefixed IDs like:
...
Edwin may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `edwin models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
edwin models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
edwin models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
edwin models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
edwin models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > EDWIN_GATEWAY_PORT > gateway.port > default 18789
```

### Why does edwin gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `edwin gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does edwin gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `EDWIN_STATE_DIR` mismatch).

Fix:

```bash
edwin gateway install --force
```
...
Edwin enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `edwin gateway --port <port>`.

### How do I run Edwin in remote mode client connects to a Gateway elsewhere
...
- The Control UI stores the token in browser localStorage key `edwin.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `edwin dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `edwin doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `EDWIN_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `edwin status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `EDWIN_CONFIG_PATH` (per-instance config)
- `EDWIN_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `edwin --profile <name> …` per instance (auto-creates `~/.edwin-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `edwin --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.edwin.*`, `edwin-gateway-<profile>.service`, `Edwin Gateway (<profile>)`).
...
```
edwin tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/edwin/edwin-YYYY-MM-DD.log
```
...
- macOS: `$EDWIN_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.edwin/logs/...`; profiles use `~/.edwin-<profile>/logs/...`)
- Linux: `journalctl --user -u edwin-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Edwin Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `edwin gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Edwin
...
1. Is the Gateway running? `edwin gateway status`
2. Is the Gateway healthy? `edwin status`
3. Does the UI have the right token? `edwin dashboard`
...
```bash
edwin channels status
edwin channels logs --channel telegram
```
...
### ELI5 edwin gateway restart vs edwin gateway

- `edwin gateway restart`: restarts the **background service** (launchd/systemd).
- `edwin gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `edwin gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Edwin assistant setup](/start/edwin) and [Agent send](/tools/agent-send).

CLI sending:

```bash
edwin message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Edwin to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `edwin pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `edwin pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `edwin doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Edwin only replies to chats it receives or to explicit sends you trigger.
...
Edwin blocks **cross-provider** messaging by default. If a tool call is bound
