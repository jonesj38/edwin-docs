...
Edwin ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Edwin also aligns
the install method:
...
When you switch channels with `edwin update`, Edwin also syncs plugin sources:
