...
This guide summarizes a sane workflow for working on the pi integration in Edwin.
...
- Trigger the agent directly:
  - `pnpm edwin agent --message "Hello" --thinking low`
...
State lives under the Edwin state directory. Default is `~/.edwin`. If `EDWIN_STATE_DIR` is set, use that directory instead.

To reset everything:

- `edwin.json` for config
...
- https://docs.edwinpai.com/testing
