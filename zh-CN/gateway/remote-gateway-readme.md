...
# 使用远程 Gateway 网关运行 Edwin.app

Edwin.app 使用 SSH 隧道连接到远程 Gateway 网关。本指南向你展示如何设置。
...
旧版注意事项：如果存在任何遗留的 `com.edwin.ssh-tunnel` LaunchAgent，请将其删除。
...
Edwin.app 连接到你的客户端机器上的 `ws://127.0.0.1:18789`。SSH 隧道将该连接转发到运行 Gateway 网关的远程机器的端口 18789。
