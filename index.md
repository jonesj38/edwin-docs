---
summary: "Edwin is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Edwin to newcomers
title: "Edwin"
---
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Edwin and bring up the Gateway in minutes.
  </Card>
  <Card title="Run the Wizard" href="/start/wizard" icon="sparkles">
    Guided setup with `edwin onboard` and pairing flows.
  </Card>
