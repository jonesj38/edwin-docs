---
summary: "Run multiple Edwin Gateways on one host (isolation, ports, and profiles)"
read_when:
...
- `EDWIN_CONFIG_PATH` — per-instance config file
- `EDWIN_STATE_DIR` — per-instance sessions, creds, caches
