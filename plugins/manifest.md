...
read_when:
  - You are building a Edwin plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (edwin.plugin.json)

Every plugin **must** ship a `edwin.plugin.json` file in the **plugin root**.
Edwin uses this manifest to validate configuration **without executing plugin
