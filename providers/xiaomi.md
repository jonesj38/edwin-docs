---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Edwin"
read_when:
  - You want Xiaomi MiMo models in Edwin
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Edwin uses
