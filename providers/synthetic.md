---
summary: "Use Synthetic's Anthropic-compatible API in Edwin"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Edwin registers it as the
...
Note: Edwin's Anthropic client appends `/v1` to the base URL, so use
