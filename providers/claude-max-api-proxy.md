...
You can point Edwin at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Edwin
...
- [Anthropic provider](/providers/anthropic) - Native Edwin integration with Claude setup-token or API keys
